...
getIntegrationMetrics(object, meta.label = meta.label, meta.batch = meta.batch, method.reduction = method.reduction, lisi_perplexity = lisi_perplexity, metrics = metrics) 
...
integrationMetrics <- lapply(object.list,function(object){
 getIntegrationMetrics(object, metrics = metrics, meta.label, meta.batch, lisi_perplexity, method.reduction)
})
```
