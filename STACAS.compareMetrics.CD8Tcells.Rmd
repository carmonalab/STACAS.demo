...
integrationMetricsSummary <- data.frame(unlist(integrationMetrics)) %>% tibble::rownames_to_column() %>% rename(unlist.integrationMetrics.="value") %>% separate(rowname, c("Method","Metric"), sep="\\.")
